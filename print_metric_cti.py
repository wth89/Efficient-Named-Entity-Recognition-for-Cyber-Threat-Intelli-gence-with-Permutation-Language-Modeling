...
data = pd.read_csv("./outputs/cti_train.txt")
...
plt.legend()
plt.grid()
plt.savefig('./outputs/validation_metrics_cti_loss.png', bbox_inches='tight', dpi=300)
plt.show()
...
plt.legend()
plt.grid()
plt.savefig('./outputs/validation_metrics_cti_metric.png', bbox_inches='tight', dpi=300)
plt.show()
...
plt.grid()
plt.savefig('./outputs/validation_metrics_cti_recall.png', bbox_inches='tight', dpi=300)
plt.show()
