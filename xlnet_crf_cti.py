...
class SUB_DataProcessor(DataProcessor):
    ...
    def getLabels(self):
        ...
        labels = ['X', '[CLS]', '[SEP]','O','B-hash','B-ip.unknown','B-malware.backdoor','B-malware.drop','B-malware.infosteal','B-malware.ransom','B-malware.unknown','B-url.cncsvr','B-url.normal','B-url.unknown','I-hash','I-ip.unknown','I-malware.backdoor','I-malware.drop','I-malware.infosteal','I-malware.ransom','I-malware.unknown','I-url.cncsvr','I-url.normal','I-url.unknown']
